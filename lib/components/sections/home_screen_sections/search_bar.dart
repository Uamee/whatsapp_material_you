...
class SearchBar extends StatefulWidget {
  /// The keyword of [SearchBar] can be controlled with a [TextEditingController].
...
class _OutlineSearchBarState extends State<SearchBar>
  ...
  Widget _buildSearchButton() {
    final searchIcon = Icon(Icons.search,
        size: 25.0, color: widget.searchButtonIconColor ?? _themeColor);

    return ConstrainedBox(
      constraints: BoxConstraints.tightForFinite(width: 48),
      child: Material(
